...
(setq org-agenda-files (quote ("~/emacs/org/todo.org"
			       "~/emacs/org/diary.org"
			       "~/emacs/org/flagged.org"
...
(setq org-mobile-directory "~/Dropbox/emacs/MobileOrg")
;; set to the name of the file where new notes will be stored
(setq org-mobile-inbox-for-pull  "~/Dropbox/emacs/MobileOrg/flagged.org") 
;; automate org-mode
...
;;;; something about ourselves
     (setq
        user-mail-address "j@redtravis.com"
        user-full-name  "Jared Travis"
        message-signature
         (concat
           "Jared Travis, EIT\n"))
...
;;;; sending mail -- replace USERNAME with your gmail username
     ...
     (setq message-send-mail-function 'smtpmail-send-it
        ...
        smtpmail-auth-credentials
          '(("smtp.gmail.com" 587 "jaredewb@gmail.com" nil))
...
;;;; view html messages inline with 
(setq mu4e-html2text-command "w3m -T text/html")

    ;;or:  need this to convert some e-mails properly
;    (setq mu4e-html2text-command "html2text -utf8 -width 72")

;; from http://www.brool.com/index.php/using-mu4e
;;;; show images
...
;;;; view html messages in default browser
    ;;; message view action
...
;; alerts
(add-hook 'mu4e-updated-hook
	  (defun new-mail-sound ()
	    (shell-command "aplay /usr/share/sounds/purple/receive.wav")))
